    ...
    <template #content>
      <div class="mt-5 d-block d-sm-flex align-center">
        <div class="d-flex align-end">
          <base-input v-model="updatedInboxes" class="subscribe__input d-inline-block" />
          <v-btn
        ...
        <v-container class="py-0 px-0">
          <v-row>
            ...
            <v-col cols="6" sm="8" class="py-0">
              <span class="subscribe__amount">{{ totalPerMonth }}</span>
            </v-col>
          </v-row>
        </v-container>
      </div>
      ...
      <v-container class="py-0 px-0">
        <v-row>
          ...
          <v-col cols="6" sm="8" class="py-0">
            <span class="subscribe__amount">$3.42</span>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" class="pt-2">
            <div class="subscribe__info">The next charge after today will be $5.00 on December 1, 2020.</div>
          </v-col>
        </v-row>
      </v-container>
